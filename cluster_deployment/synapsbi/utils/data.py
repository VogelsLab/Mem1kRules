...
def read_monitor_spiketime_files(
    ...
    for line in lines:
        ...
        try:
            ...
            print("seed", seed, "problem with file", filename)
...
def read_monitor_weights_files(
    ...
    for con_type in plastic_connections:
        ...
        try:
            ...
            print("problem opening monitor file, returning None")
            return(None)
        lines = f.readlines()
        if len(lines)<2:
            print("seed", seed, "problem with file", filename)
            ...
            w_dict[con_type]['t'] = np.NAN
            w_dict[con_type]['w'] = np.NAN
        else:
            try:
...
def save_data_to_hdf5(
    ...
    if data is not None:
        ...
        print("fetching auryn monitor files for every simulation")
        counter = 0
