#ifndef CHECKERSCORER_H_
#define CHECKERSCORER_H_
...
/*! \brief This class is adapted from the auryn RateChecker Class
 * 
 * 
...
class CheckerScorer : public Checker
{
private:
...
public:
	 ...
	 */
	CheckerScorer(SpikingGroup * source, AurynFloat min, AurynFloat max, AurynFloat tau);
	virtual ~CheckerScorer();
