...
#-------------------------------------------------------------                 
#            
#SBATCH --job-name=seq_1k_mfnpe_rho2_bis
#SBATCH --reservation=vogelgrp_153  #####vogelgrp_58 #SBATCH --exclude=delta216 ### put back on when using vogelgrp_58 vogelgrp_135
#SBATCH --exclude=delta216
#
#SBATCH --output=sim_workdir/array_%A-%a.log
#
#SBATCH --array=1-1000:1 #################################################### TO CHANGE EVERY TIME, 2500 poly, 3103 MLPs
#              
...
# config=/nfs/scistore23/vogelgrp/bconfavr/synapsesbi/synapsbi/simulator/cpp_simulators/seq_CVAIF_EEIE_T4wvceciMLP_params.txt
