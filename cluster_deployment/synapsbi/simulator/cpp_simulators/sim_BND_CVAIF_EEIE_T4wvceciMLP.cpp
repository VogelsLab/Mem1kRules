...
int main(int ac, char* av[])
{
	...
	std::srand(std::time(0)); // PUT BACK THIS !!!!!!!!!!!!!!!!!!!!!!
	sys->set_master_seed(std::rand()); //And this
	...
	///////////////////////////////////////////////////////////////////////////////
	// std::cout << "rate_poisson=" << rate_poisson << ", active input rate=" << active_input_rate;
	// SpikeMonitor* smon_input = new SpikeMonitor(stimgroup, sys->fn("input.e","ras") ); ///////////////////////////////////////////////////////////////////////////////
	///////////////////////////////////////////////////////////////////////////////

	///////////////////////////////////////////// TO REMOVE FOR SBI SIMS  //////////////////////////////////
...
// 	///////////////////// Total time: 1, 10, 20, 60, 120, 300, 600, 1200, 3600 ///
	...
	// const int n_breaks = 3; //shorter sim
	///////////////////// Total time: 1, 10, 20, 60, 120, 300, 600, 1200 ///
// 	int break_durations [n_breaks] = {1, 9, 10, 40, 60,  180, 300, 600};
	// int break_durations [n_breaks] = {1, 9, 110};
