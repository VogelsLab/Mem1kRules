...
round_name = "1k_seq_mf_npe_rho1min2_130325"

from synapsbi.simulator import Simulator_seq_IF_EEEIIEII_6pPol as Simulator 


print("Loading samples that have been simulated") # Choose one appropriate for plastic simulations
# thetas = np.load(save_dir + "poly_2500.npz")["thetas"]
thetas = np.load(save_dir + "1k_mf_npe_rho1min2_130325.npy")
# thetas = np.load(save_dir + "MLP_3103.npz")["thetas"]
# thetas = np.load(save_dir + "4446_samples_Nastya_22012025.npy")
